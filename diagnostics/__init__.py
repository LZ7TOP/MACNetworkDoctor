from diagnostics.network import check_network, check_latency, benchmark_dns, check_port
...
from diagnostics.fix import flush_dns, disable_system_proxy, flush_arp, renew_dhcp
